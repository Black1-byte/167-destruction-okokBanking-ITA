...
window.addEventListener('message', function(event) {
	switch (event.data.action) {
			...
			if (selectedWindow == "none") {
				...
				$('#menu').html(`
					<div class="d-flex justify-content-center flex-column align-items-center">
						...
						<br>
						<div style="font-size: 40px; color: #fff;">Caricamento Dati...</div>
					</div>
				`);
				$("#menu").fadeIn();
				$(".main_card").fadeIn();
				...
				setTimeout(function(){
					...
					$('#menu').html(`
						<div class="col-md-2 d-flex flex-column" style="border-right: 1px solid rgba(62, 63, 75); width: 177px;">
							...
							<hr>
							<span class="sidebar-title">Personale</span>
							<div id="sidebar"></div>
						...
						<div class="col-md-10" style="width: 82%; display: flex; flex-direction: column;">
							<div class="d-flex justify-content-between align-items-center">
								<span class="selected-page" style="margin-left: 15px;"><span id="page-title">Panoramica</span></span>
								<div>
		...
		case 'transactions_page':
			...
			$('#page-title').html('Transazioni');

			if (event.data.isInSociety){
				society = `<span class="sidebar-title mt-5">Società</span>
						   <p class="sidebar-item mt-2" id="society_page" style="margin-bottom: 12px;"><i class="bi bi-grid-1x2-fill"></i> <span class="ms-1">Panoramica</span></p>
						   <p class="sidebar-item" id="society_transactions" style="margin-bottom: 12px;"><i class="fas fa-exchange-alt"></i> <span class="ms-1">Transazioni</span></p>`;
			} else {
				society = '';
			}

			$('#sidebar').html(`
				<p class="sidebar-item mt-2" id="overview_page" style="margin-bottom: 12px;"><i class="bi bi-grid-1x2-fill"></i> <span class="ms-1">Panoramica</span></p>
				<p class="sidebar-item selected" id="transactions_page" style="margin-bottom: 12px;"><i class="fas fa-exchange-alt"></i> <span class="ms-1">Transazioni</span></p>
				<p class="sidebar-item mt-2" id="settings_page" style="margin-bottom: 12px;"><i class="fas fa-cog"></i> <span class="ms-1">Impostazioni</span></p>
				${society}
			`);
			...
			for(var i = 0; i < num; i++) {
				...
				if (db.type == 'transfer' && db.receiver_identifier == event.data.identifier) {
					icon = '<td class="align-middle"><span style="background-color: #131313cc; padding: 10px 15px 10px 15px; border-radius: 10px;"><i class="bi bi-download"></i></span></td>';
					data = `<td class="align-middle" style="font-weight: 500;">
								From <span style="color: #e7cc00bd; font-weight: 600;">${db.sender_name}</span>
				...
				// Sent
					...
					icon = '<td class="align-middle"><span style="background-color: #131313cc; padding: 10px 15px 10px 15px; border-radius: 10px;"><i class="bi bi-upload"></i></span></td>';
					data = `<td class="align-middle" style="font-weight: 500;">
								To <span style="color: #e7cc00bd; font-weight: 600;">${db.receiver_name}</span>
								<div style="margin-top: -5px;">Invia</div>
							</td>`;
				...
				// Deposited
					...
					icon = '<td class="align-middle"><span style="background-color: #131313cc; padding: 10px 15px 10px 15px; border-radius: 10px;"><i class="bi bi-download"></i></span></td>';
					data = `<td class="align-middle" style="font-weight: 500;">
								Into <span style="color: #e7cc00bd; font-weight: 600;">${db.receiver_name}</span>
								<div style="margin-top: -5px;">Depositato</div>
							</td>`;
					amount = `<td class="align-middle" style="font-weight: 500;"><span style="color: #2ecc71; float: right;">+ ${db.value.toLocaleString()} EUR</span> </td>`;
				// Withdrawn
					...
					data = `<td class="align-middle" style="font-weight: 500;">
								From <span style="color: #e7cc00bd; font-weight: 600;">${db.sender_name}</span>
								<div style="margin-top: -5px;">Ritirato</div>
							</td>`;
					amount = `<td class="align-middle" style="font-weight: 500;"><span style="float: right;"> - ${db.value.toLocaleString()} EUR</span> </td>`;
				}
			...
			$('#page_info').html(`
				<div class="row mb-3">
					<div class="col col-md-3">
						<div class="card" style="background-color: #e7cc00bd; border-radius: 10px; color: #fff;">
						  <div class="card-body text-center">
						    <h6 class="card-title" style="font-weight: 600; font-size: 20px;">TRANSAZIONI</h6>
					...
					<div class="col col-md-3">
						<div class="card" style="background-color: #e7cc00bd; border-radius: 10px; color: #fff;">
						  <div class="card-body text-center">
						    <h6 class="card-title" style="font-weight: 600; font-size: 20px;">ENTRATA</h6>
					...
					<div class="col col-md-3">
						<div class="card" style="background-color: #e7cc00bd; border-radius: 10px; color: #fff;">
						  <div class="card-body text-center">
						    <h6 class="card-title" style="font-weight: 600; font-size: 20px;">USCITA</h6>
					...
					<div class="col col-md-3">
						<div class="card" style="background-color: #e7cc00bd; border-radius: 10px; color: #fff;">
						  <div class="card-body text-center">
						    <h6 class="card-title" style="font-weight: 600; font-size: 20px;">GUADAGNO</h6>
				...
				<table id="transactionsTable">
					<tbody id="transactionsData">
						<tr>
							<td class="align-middle"><span style="background-color: #131313cc; padding: 5px 10px 5px 10px; border-radius: 10px;"><i class="bi bi-download"></i></span></td>
							<td class="align-middle" style="font-weight: 500; font-size: 16px;">
								To <span style="color: #e7cc00bd;">Arthur James</span>
								<div style="margin-top: -5px;">Invia</div>
							</td>
						...
						<tr>
							<td class="align-middle"><span style="background-color: #131313cc; padding: 5px 10px 5px 10px; border-radius: 10px;"><i class="bi bi-upload"></i></span></td>
							<td class="align-middle" style="font-weight: 500; font-size: 16px;">
								Into <span style="color: #e7cc00bd;">Bank Account</span>
								<div style="margin-top: -5px;">Depositato</div>
							</td>
							<td class="align-middle" style="font-weight: 500;">28 Aug 04:43</td>
		...
		case 'society_transactions':
			...
			$('#page-title').html('Transazioni ['+event.data.societyInfo.society_name+']');

			if (event.data.isInSociety){
				society = `<span class="sidebar-title mt-5">Society</span>
						   <p class="sidebar-item mt-2" id="society_page" style="margin-bottom: 12px;"><i class="bi bi-grid-1x2-fill"></i> <span class="ms-1">Panoramica</span></p>
						   <p class="sidebar-item selected" id="society_transactions" style="margin-bottom: 12px;"><i class="fas fa-exchange-alt"></i> <span class="ms-1">Transazioni</span></p>`;
			} else {
				society = '';
			}
			...
			$('#sidebar').html(`
				<p class="sidebar-item mt-2" id="overview_page" style="margin-bottom: 12px;"><i class="bi bi-grid-1x2-fill"></i> <span class="ms-1">Panoramica</span></p>
				<p class="sidebar-item" id="transactions_page" style="margin-bottom: 12px;"><i class="fas fa-exchange-alt"></i> <span class="ms-1">Transazioni</span></p>
				<p class="sidebar-item mt-2" id="settings_page" style="margin-bottom: 12px;"><i class="fas fa-cog"></i> <span class="ms-1">Impostazioni</span></p>
				${society}
			`);
				...
				<table id="transactionsTable">
					<tbody id="transactionsData">
						...
						<tr>
							<td class="align-middle"><span style="background-color: #131313cc; padding: 5px 10px 5px 10px; border-radius: 10px;"><i class="bi bi-upload"></i></span></td>
							<td class="align-middle" style="font-weight: 500; font-size: 16px;">
								Into <span style="color: #e7cc00bd;">Conto Banca</span>
								<div style="margin-top: -5px;">Depositato</div>
							</td>
							<td class="align-middle" style="font-weight: 500;">28 Aug 04:43</td>
							<td class="align-middle" style="font-weight: 500; color: #2ecc71;">+ 57 000 EUR</td>
		...
		pin_numpad(event.data.pin, event.data.amount, event.data.society, event.data.target);

		$(".pin_card").fadeIn();

		selectedWindow = "insertPin";
		break
	}
});
...
$(document).on('click', ".close-pin", function() {
	var popuprev_sound = new Audio('popupreverse.mp3');
	popuprev_sound.volume = 0.2;
	popuprev_sound.play();
...
function overview_page_function(event) {
	...
	$('#sidebar').html(`
		<p class="sidebar-item mt-2 selected" id="overview_page" style="margin-bottom: 12px;"><i class="bi bi-grid-1x2-fill"></i> <span class="ms-1">Panoramica</span></p>
		<p class="sidebar-item" id="transactions_page" style="margin-bottom: 12px;"><i class="fas fa-exchange-alt"></i> <span class="ms-1">Transazioni</span></p>
		<p class="sidebar-item mt-2" id="settings_page" style="margin-bottom: 12px;"><i class="fas fa-cog"></i> <span class="ms-1">Impostazioni</span></p>
		${society}
	`);
	...
	$('#page_info').html(`
		<div class="col-md-7" style="border-right: 1px solid rgba(62, 63, 75);">
			<div class="card text-center" style="background-color: transparent; border-radius: 10px; box-shadow: 0px 0px 5 0px rgba(0, 0, 0, 0.75);">
				<div class="card-header" style="background-color: #8f8f8f7a; border-top-right-radius: 10px; border-top-left-radius: 10px;">
					<span style="color: #fff; font-size: 18px;"><i class="fas fa-chart-line"></i> Statistiche</span>
				</div>
				<div class="card-body" style="background-color: #131313cc; border-bottom-left-radius: 10px; border-bottom-right-radius: 10px;">
					<div>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="card h-100" style="background-color: transparent; border-radius: 10px; box-shadow: 0px 0px 5 0px rgba(0, 0, 0, 0.75); margin-top: 12px;">
						<div class="card-header text-center" style="background-color: #8f8f8f7a; border-top-right-radius: 10px; border-top-left-radius: 10px;">
							<span style="color: #fff; font-size: 18px;"><span><i class="fas fa-exchange-alt"></i> Ultime Transazioni</span> <span class="badge bg-primary viewall-badge" style="position: absolute; font-size: 14px; right: 9px; top: 10px;" id="view_all_transactions"><i class="fas fa-eye"></i> VEDI TUTTO</span></span>
						</div>
						<div class="card-body" style="background-color: #131313cc; border-bottom-left-radius: 10px; border-bottom-right-radius: 10px; padding: 0.6rem 1rem;">
							<table id="lastTransactionsTable">
								<tbody id="lastTransactionsData">
									...
									<tr>
										<td class="align-middle"><span style="background-color: #131313cc; padding: 5px 10px 5px 10px; border-radius: 10px;"><i class="bi bi-upload"></i></span></td>
										<td class="align-middle" style="font-weight: 500; font-size: 16px;">
											From <span style="color: #e7cc00bd;">Arthur James</span>
											<div style="margin-top: -5px;">Received</div>
										</td>
									...
									<tr>
										<td class="align-middle"><span style="background-color: #131313cc; padding: 5px 10px 5px 10px; border-radius: 10px;"><i class="bi bi-download"></i></span></td>
										<td class="align-middle" style="font-weight: 500; font-size: 16px;">
											From <span style="color: #e7cc00bd;">Bank Account</span>
											<div style="margin-top: -5px;">Ritirato</div>
										</td>
		...
		<div class="col-md-5">
			<div class="col-md-12">
				<div class="card" style="background-color: transparent; border-radius: 10px; box-shadow: 0px 0px 5 0px rgba(0, 0, 0, 0.75);">
					<div class="card-header text-center" style="background-color: #8f8f8f7a; border-top-right-radius: 10px; border-top-left-radius: 10px;">
						<span style="color: #fff; font-size: 18px;"><i class="bi bi-credit-card-fill"></i> Informazioni</span>
					</div>
					<div class="card-body" style="background-color: #131313cc; border-bottom-left-radius: 10px; border-bottom-right-radius: 10px; font-size: 16px;">
						...
						<hr>
						<p class="card-text text-center" style="font-size: 20px;"><span style="color: #fff;">Saldo:</span> <span id="playerBankMoney"></span> EUR</p>
				...
				<div class="card text-center h-100" style="background-color: transparent; border-radius: 10px; box-shadow: 0px 0px 5 0px rgba(0, 0, 0, 0.75); margin-top: 12px;">
					...
					<div class="card-body" style="background-color: #131313cc; border-bottom-left-radius: 10px; border-bottom-right-radius: 10px;">
						<div class="d-flex justify-content-center">
							<button type="button" id="depositMoneyModal" class="btn btn-blue flex-grow-1" style="border-radius: 10px; flex-basis: 100%;" data-bs-toggle="modal" data-bs-target="#depositModal"><i class="bi bi-upload"></i> Deposita</button>
						</div>
						<div class="d-flex justify-content-center" style="margin-top: 7px;">
							<button type="button" id="withdrawMoneyModal" class="btn btn-blue flex-grow-1" style="border-radius: 10px; flex-basis: 100%;" data-bs-toggle="modal" data-bs-target="#withdrawModal"><i class="bi bi-download"></i> Ritira</button>
						</div>
						<div class="d-flex justify-content-center" style="margin-top: 7px;">
							<button type="button" id="transferMoneyModal" class="btn btn-blue flex-grow-1" style="border-radius: 10px; flex-basis: 100%;" data-bs-toggle="modal" data-bs-target="#transferModal"><i class="fas fa-exchange-alt"></i> Trasferisci</button>
						</div>
					</div>
				</div>
			</div>
	...
	for(var i = 0; i < num; i++) {
		...
		// Received
		if (db.type == 'transfer' && db.receiver_identifier == event.data.identifier) {
			icon = '<td class="align-middle"><span style="background-color: #131313cc; padding: 5px 10px 5px 10px; border-radius: 10px;"><i class="bi bi-download"></i></span></td>';
		...
		// Sent
			...
			icon = '<td class="align-middle"><span style="background-color: #131313cc; padding: 5px 10px 5px 10px; border-radius: 10px;"><i class="bi bi-upload"></i></span></td>';
			data = `<td class="align-middle" style="font-weight: 500; font-size: 16px;">
						To <span style="color: #e7cc00bd; font-weight: 600;">${db.receiver_name}</span>
						<div style="margin-top: -5px;">Invia</div>
					</td>`;
	...
	gradient.addColorStop(0, 'rgba(231, 204, 0, 0.5)');
    gradient.addColorStop(1, 'rgba(231, 204, 0, 0)');
...
function society_page_function(event) {
	...
	if (event.data.isInSociety){
		society = `<span class="sidebar-title mt-5">Society</span>
				   <p class="sidebar-item mt-2 selected" id="society_page" style="margin-bottom: 12px;"><i class="bi bi-grid-1x2-fill"></i> <span class="ms-1">Panoramica</span></p>
				   <p class="sidebar-item" id="society_transactions" style="margin-bottom: 12px;"><i class="fas fa-exchange-alt"></i> <span class="ms-1">Transazioni</span></p>`;
	} else {
		society = '';
	}
		...
		<div class="col-md-7" style="border-right: 1px solid rgba(62, 63, 75);">
			...
			<div class="row">
				<div class="col-md-12">
					<div class="card h-100" style="background-color: transparent; border-radius: 10px; box-shadow: 0px 0px 5 0px rgba(0, 0, 0, 0.75); margin-top: 12px;">
						<div class="card-header text-center" style="background-color: #8f8f8f7a; border-top-right-radius: 10px; border-top-left-radius: 10px;">
							<span style="color: #fff; font-size: 18px;"><span><i class="fas fa-exchange-alt"></i> Ultime Transazioni</span> <span class="badge bg-primary viewall-badge" style="position: absolute; font-size: 14px; right: 9px; top: 10px;" id="view_all_transactions_society"><i class="fas fa-eye"></i> VEDI TUTTO</span></span>
						</div>
						<div class="card-body" style="background-color: #131313cc; border-bottom-left-radius: 10px; border-bottom-right-radius: 10px; padding: 0.6rem 1rem;">
							<table id="lastTransactionsTable">
								<tbody id="lastTransactionsData">
...
function settings_page_function(event) {
	...
	$('#sidebar').html(`
		<p class="sidebar-item mt-2" id="overview_page" style="margin-bottom: 12px;"><i class="bi bi-grid-1x2-fill"></i> <span class="ms-1">Panoramica</span></p>
		<p class="sidebar-item" id="transactions_page" style="margin-bottom: 12px;"><i class="fas fa-exchange-alt"></i> <span class="ms-1">Transazioni</span></p>
		<p class="sidebar-item mt-2 selected" id="settings_page" style="margin-bottom: 12px;"><i class="fas fa-cog"></i> <span class="ms-1">Impostazioni</span></p>
		${society}
	`);
	...
	$('#page_info').html(`
		<div class="col-md-12 d-flex flex-grow-1 flex-column h-100" style="flex: 1 1 50%;">
			<div class="card d-flex flex-column flex-grow-1" style="background-color: transparent; border-radius: 10px; box-shadow: 0px 0px 5 0px rgba(0, 0, 0, 0.75);">
				...
				<div class="card-body flex-grow-1" style="background-color: #131313cc; border-bottom-left-radius: 10px; border-bottom-right-radius: 10px;">
					<div class="">
						<div class="row">
							<div class="col col-md-6 d-flex justify-content-center">
								<div class="card w-100 h-100" style="background-color: #131313cc; border-radius: 10px; color: #fff;">
								  <div class="card-body text-center">
								    <span style="font-size: 24px; color: #fff;">Prendi Carta di Credito</span>
									<button type="button" id="change_iban" class="btn btn-blue" style="border-radius: 10px; flex-basis: 100%; margin-top: 12px; width: 100%;" disabled><i class="fas fa-paper-plane"></i> Sottoscrivi</button>
								  </div>
								</div>
							</div>
							<div class="col col-md-6 d-flex align-items-center">
								<div class="card w-100 h-100 d-flex justify-content-center" style="background-color: #e7cc00bd; border-radius: 10px; color: #fff;">
								  <div class="card-body text-center" style="font-size: 18px;">
								    <span>La Carta di Credito Costa ${event.data.ibanCost}$</span>
								    <hr style="color: #fff;">
								    <span>Non Perdere la tua Carta di Credito </span>
								    <hr style="color: #fff;">
									<span>Non dare la tua Carta di Credito a degli Sconosciuti</span>
								  </div>
								</div>
							</div>
						</div>
			...
			<div class="card d-flex flex-column flex-grow-1" style="background-color: transparent; border-radius: 10px; box-shadow: 0px 0px 5 0px rgba(0, 0, 0, 0.75); margin-top: 12px;">
				<div class="card-header text-center" style="background-color: #8f8f8f7a; border-top-right-radius: 10px; border-top-left-radius: 10px;">
					<span style="color: #fff; font-size: 18px;">
						<span><i class="fas fa-key"></i> Codice PIN/span>
					</span>
				</div>
				<div class="card-body flex-grow-1" style="background-color: #131313cc; border-bottom-left-radius: 10px; border-bottom-right-radius: 10px;">
					<div class="">
						<div class="row">
							<div class="col col-md-6 d-flex justify-content-center">
								<div class="card w-100 h-100" style="background-color: #131313cc; border-radius: 10px; color: #fff;">
								  <div class="card-body text-center">
								    <span style="font-size: 24px; color: #fff;">Cambia PIN</span>
									<input type="password" maxlength="4" id="new_pin" class="form-control text-center" placeholder="Nuovo PIN" onkeyup="checkIfEmptySettings()" style="margin-top: 12px; width: 100%;">
									<button type="button" id="change_pin" class="btn btn-blue" style="border-radius: 10px; flex-basis: 100%; margin-top: 12px; width: 100%;" disabled><i class="fas fa-paper-plane"></i> Sottoscrivi</button>
								  </div>
								</div>
							</div>
							<div class="col col-md-6 d-flex align-items-center">
								<div class="card w-100 h-100 d-flex justify-content-center" style="background-color: #e7cc00bd; border-radius: 10px; color: #fff;">
								  <div class="card-body text-center" style="font-size: 18px;">
								    <span>Il Cambio di PIN costa ${event.data.pinCost}€</span>
								    <hr style="color: #fff;">
									<span>Il Numero Massimo di Caratteri è 4 ${event.data.pinCharNum}</span>
									<hr style="color: #fff;">
									<span>Puoi usare solo numeri</span>
								  </div>
								</div>
							</div>
						</div>
...
var canSetClick2 = true;
var counter = 0;

function pin_numpad(pin, amount, society, target) {
	var input = "";
	counter = amount;
	correct = pin;
	dots2 = document.querySelectorAll(".dot2");
	numbers2 = document.querySelectorAll(".number2");
	dots2 = Array.prototype.slice.call(dots2);
	numbers2 = Array.prototype.slice.call(numbers2);
	

	numbers2.forEach(function (number2, index2) {
		if (canSetClick2){
			number2.addEventListener("click", numpad2);
		}
		function numpad2() {
			if (index2 == 9 || index2 == 11) {
				if (index2 == 9) {
					dots2.forEach(function (dot2, index2) {
							dot2.className = "dot2 clear";
						});
				} else if (index2 == 11) {
					if (input == correct) {
						var correct_sound = new Audio('correct.mp3');
						...
						dots2.forEach(function (dot2, index2) {
							dot2.className = "dot2 active correct";
						});
						...
						dots2.forEach(function (dot2, index2) {
							dot2.className = "dot2 active wrong";
						});
					}
				}
				setTimeout(function () {
				...
				number2.className = "number2 grow";
				input += index2 + 1;
				dots2[input.length - 1].className = "dot2 active";
				setTimeout(function () {
